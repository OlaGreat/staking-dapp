...
//                 <p className="text-3xl font-bold">{safeNumber(userDetails.stakedAmount)}</p>
...
//                   <Button
//                     onClick={()=> withdraw(String(userDetails.stakedAmount))}
//                     disabled={!isConnected || parseFloat(String(userDetails.stakedAmount)) <= 0 || formatTimeRemaining() !== "Ready" || isTransacting}
//                     variant="outline"
//                     size="sm"
//                   >
...
//                   disabled={!isConnected || parseFloat(String(userDetails.stakedAmount)) <= 0 || isTransacting}
//                   variant="ghost"
//                   size="sm"
